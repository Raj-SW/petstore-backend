<!-- Mirror copy for root-level discovery. Canonical: docs/superpowers/specs/2026-06-21-professional-card-and-appointments-search-design.md — keep both in sync. -->
