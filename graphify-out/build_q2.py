...
semantic = {'nodes': deduped_nodes, 'edges': all_edges, 'hyperedges': all_hyperedges}
...
labels = {
    **{cid: 'Community ' + str(cid) for cid in communities}
}
questions = suggest_questions(G, communities, labels)
tokens = {'input': 0, 'output': 0}

out_dir = Path('graphify-out/frontend-q2')
out_dir.mkdir(exist_ok=True)

report = generate(G, communities, cohesion, labels, gods, surprises, detection, tokens, 'frontend/src/Pages', suggested_questions=questions)
